...
const Contact = () => {
  ...
  return (
    <div className=" flex justify-center mt- 5 mx-4 md:mx-10 mb-30 p-4">
      <div className="w-full max-w-lg shadow-lg rounded-lg p-6 md:p-10">
        <h1 className="text-3xl text-center font-bold pb-6">Contact with us</h1>
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-amber-500 to-amber-800 text-white p-3 rounded-lg w-full md:w-auto font-semibold hover:shadow-md transform hover:scale-105 transition-all"
          >
            Send Message
          </button>
        </form>
